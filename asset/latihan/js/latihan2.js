...
intro1 = setTimeout(function () {
    intro = new sound("../asset/speech/latihan2/intro1.mp3");
    intro.play();
}, 0);

intro2 = setTimeout(function () {
    intro = new sound("../asset/speech/latihan2/intro2.mp3");
    intro.play();
}, 7000);

intro3 = setTimeout(function () {
    intro = new sound("../asset/speech/latihan2/intro3.mp3");
    intro.play();
}, 15000);
intro4 = setTimeout(function () {
    intro = new sound("../asset/speech/latihan2/intro4.mp3");
    intro.play();
}, 22000);
intro5 = setTimeout(function () {
    intro = new sound("../asset/speech/latihan2/intro5.mp3");
    intro.play();
}, 29000);
...
function aktivitas(){
    aktivitas1 = setTimeout(function () {
        aktivitas1 = new sound("../asset/speech/latihan2/aktivitas1.mp3");
        aktivitas1.play();
    }, 0);
    
    aktivitas2 = setTimeout(function () {
        aktivitas = new sound("../asset/speech/latihan2/aktivitas2.mp3");
        aktivitas.play();
    }, 7000);
    
    aktivitas3 = setTimeout(function () {
        aktivitas = new sound("../asset/speech/latihan2/aktivitas3.mp3");
        aktivitas.play();
    }, 15000);
}
