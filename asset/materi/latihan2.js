...
function hitung3(x) {
    ...
    x.classList.replace('animate__bounceIn', 'animate__flash');
    x.classList.add('shadow-sm');
    txtAngka.innerHTML = '<img src="../../asset/image/textBilangan/txt' + bilangan3 + '.png" alt="1" class="txtAngka animate__animated animate__bounce">';
    txtAngka.classList.add('border', 'bg-white');
    Speech = new sound("../asset/speech/" + bilangan3 + ".mp3");
    Speech.play();
    if (bilangan3 == (listPertanyaan[soalNomor].benda.length)) {
        setTimeout(function () {
            kesimpulan();
        }, 3000);
    }
...
function mulai() {
    ...
    bilangan = 0; bilangan2 = 0; bilangan3 =0;
